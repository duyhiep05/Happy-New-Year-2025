...
// Giả sử có một hàm xử lý khi bắn pháo hoa hoàn thành
function fireworksComplete() {
    ...
    message.style.fontFamily = "'Russo One', sans-serif";
    message.style.textShadow = "0 0 10px #fff, 0 0 20px #ff00ff, 0 0 30px #ff00ff";
    document.body.appendChild(message);

	const subMessage = document.createElement("div");
subMessage.innerText = "Chúc mọi người năm mới vui vẻ, hạnh phúc và bình an!!!";
subMessage.style.position = "absolute";
subMessage.style.top = "55%";
subMessage.style.left = "50%";
subMessage.style.transform = "translate(-50%, -50%)";
subMessage.style.color = "#fff";
subMessage.style.fontSize = "1.5em";
subMessage.style.fontFamily = "'Russo One', sans-serif";
subMessage.style.textShadow = "0 0 10px #fff, 0 0 20px #00ff00, 0 0 30px #00ff00";
document.body.appendChild(subMessage);
}

// Tùy thuộc vào logic, bạn gọi hàm `fireworksComplete()` sau khi pháo hoa kết thúc
setTimeout(() => {
    fireworksComplete();
}, 5000); // Giả sử pháo hoa kéo dài 5 giây
